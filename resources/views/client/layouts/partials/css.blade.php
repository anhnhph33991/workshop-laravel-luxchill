<!-- Favicon -->
<link rel="icon" type="image/x-icon" href="{{ asset('assets/theme/client/images/icons/favicon.png') }}">

<!-- Plugins CSS File -->
<link rel="stylesheet" href="{{ asset('assets/theme/client/css/bootstrap.min.css') }}">

<!-- Main CSS File -->
<link rel="stylesheet" href="{{ asset('assets/theme/client/css/demo4.min.css') }}">
