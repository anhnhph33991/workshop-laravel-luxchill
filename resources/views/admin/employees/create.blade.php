                                    ...
                                    <div class="position-relative d-inline-block">
                                        ...
                                        <div class="avatar-lg">
                                            <div class="avatar-title bg-light">
                                                <img src id="projectlogo-img" class="avatar-lg h-auto"
                                                    style="height: 100%" />
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        is-invalid
                                        @enderror"
                                            placeholder="Nhập email" value="{{ old('email') }}" tabindex="3">
                                        @error('email')
                                            <div class="invalid-feedback text-validate">
                                                *{{ $message }}
                                            </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        @enderror"
                                            ...
                                            value="{{ old('date_of_birth') }}" tabindex="5" />
                                        @error('date_of_birth')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="tel" name="salary"
                                            ...
                                            is-invalid
                                        @enderror"
                                            placeholder="Nhập lương" value="{{ old('salary') }}" tabindex="7">
                                        @error('salary')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        is-invalid
                                        @enderror"
                                            placeholder="Nhập họ" value="{{ old('last_name') }}" tabindex="2">
                                        @error('last_name')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        is-invalid
                                        @enderror"
                                            placeholder="Nhập số điện thoại" value="{{ old('phone') }}" tabindex="4">
                                        @error('phone')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        @enderror"
                                            ...
                                            value="{{ old('hire_date') }}" tabindex="6" />
                                        @error('hire_date')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="address"
                                            ...
                                            is-invalid
                                        @enderror"
                                            placeholder="Nhập địa chỉ" value="{{ old('address') }}" tabindex="8">
...
@section('script')
    <script src="{{ asset('assets/js/admin/employee/create.js') }}"></script>
@endsection
